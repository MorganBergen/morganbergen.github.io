...
react does not prescribe how you addd css files.  in the simplest case, you'll add a `<link>` tage to your html.  if you use a build tool or framework, consult its documentation to learn how to add a css file to your project.
